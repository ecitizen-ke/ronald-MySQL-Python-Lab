...
@state_bp.route("/api/v1/filter", methods=["GET"])
...
@state_bp.route("/api/v1/states/name_asc", methods=["GET"])
...
@state_bp.route("/api/v1/population", methods=["PATCH"])
...
@state_bp.route("/api/v1/remove-state", methods=["DELETE"])
def deleteState():
    state = State()
    data = request.get_json()
    id = data.get('id')
...
@state_bp.route("/api/v1/average-population", methods=["GET"])
...
@state_bp.route("/api/v1/state-capital", methods=["GET"])
...
@state_bp.route("/api/v1/searchByName",methods=["POST"])
...
@state_bp.route("/api/v1/admiteed1750-1850",methods=["GET"])
